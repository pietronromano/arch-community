...
* **Special Interest Groups (SIGs)** are persistent open groups that focus on a part of the project.
  ...
  Anyone is welcome to participate and contribute provided they follow the Architecture Code of Conduct.
  ...
  * **Subprojects** Each SIG can have a set of subprojects.
    ...
    Some subprojects will be part of the main Architecture deliverables while others will be more speculative and live in the `Architecture-sigs` github org.
...
A first step to contributing is to pick from the [list of Architecture SIGs](sig-list.md).
